...
public class Splitter extends JFrame implements ActionListener,ItemListener
{
  ...
  JButton b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,b12,b13,b14,b15,b16,b17,b18,b19,b20,b99;
  JButton bsp;
  JButton ab1,ab2,ab3;
  JTextField tf1,tf2,tf3,tf4,tf5,tf6,tf7,tf8,t99;
  JTextArea ta1,ta2;
  ...
  JComboBox cb;
  JPanel p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p99;
  ...
  public Splitter()
  {
    super("ALL IN ONE Splitter - Powered by Java");
try
        {
    ...
    t99 =new JTextField(25);
    b4=new JButton("Browse");
    b4.addActionListener(this);
    b99=new JButton("Browse.");
    b99.addActionListener(this);
    p3=new JPanel(new FlowLayout(FlowLayout.LEFT));
    p3.add(tf1);
    p3.add(b4);
    p99=new JPanel(new FlowLayout(FlowLayout.LEFT));
    p99.add(t99);
    p99.add(b99);
    ...
    fc3.addChoosableFileFilter(new filter1());
     ...
     tf3.addFocusListener(new FocusAdapter()
     {
       public void focusLost(FocusEvent fe)
       {
        ...
        { 
           JOptionPane.showMessageDialog((Container)null,tf3.getText()+" : This is not a valid size","Splitter ",JOptionPane.OK_OPTION);
        }
      }
     });
     getConfig();
 ...
 public void actionPerformed(ActionEvent e)
 {
   ...
   else if(e.getSource()==b5)
   {
     boolean bx=true;
     if(ctr==0)
       JOptionPane.showMessageDialog((Container)null,"No source file is selected","Splitter ",JOptionPane.OK_OPTION);
     else if(tf1.getText().equals(""))
       JOptionPane.showMessageDialog((Container)null,"No split folder is entered","Splitter ",JOptionPane.OK_OPTION);
     else
     {
     String dst=tf1.getText();
     String dst1=t99.getText();
     File f,f1;
     try
     {
       f=new File(dst);
     ...
     for(int i=0;i<ctr;i++)
     {
       ...
       String jsf1=new File(str[i]).getName();
       String dest1=f1.toString()+"/"+getName(jsf1,0);
      
       int res=split(str[i],dest,dest1,comments,no[i],size[i],lsize[i],del,wipe,batch);
       if(res==0)
         bx=false;
     }
      if(bx)
    	  JOptionPane.showMessageDialog((Container)null,"Splitted Successfully!","Splitter ",JOptionPane.INFORMATION_MESSAGE);
      else
       JOptionPane.showMessageDialog((Container)null,"Splitter encounters some errors!  Only Correct files if any are Splitted Successfully!","Splitter ",JOptionPane.OK_OPTION);
     }catch(Exception ef){
        JOptionPane.showMessageDialog((Container)null,"Destination folder is not entered properly","Splitter ",JOptionPane.OK_OPTION);
     }
   ...
   else if(e.getSource()==b10)
   {
     ...
     if(tf4.getText().equals(""))
       JOptionPane.showMessageDialog((Container)null,"No split file is entered","Splitter ",JOptionPane.OK_OPTION);
     else if(!(new File(tf4.getText()).exists()))
        JOptionPane.showMessageDialog((Container)null,"Split file you specified not found or not correct!","Splitter ",JOptionPane.OK_OPTION);     
     else if(tf5.getText().equals(""))
       JOptionPane.showMessageDialog((Container)null,"Merge folder should be entered","Splitter ",JOptionPane.OK_OPTION);
     else
     {
       ...
       {
        JOptionPane.showMessageDialog((Container)null,"Error occured in merging: Not merged","Splitter ",JOptionPane.OK_OPTION);
       }
     }
   }
   ...
   else if(e.getSource()==b12)
   {
     try
     {
       ...
       if (!flc.exists())
        JOptionPane.showMessageDialog((Container)null,"Comment File not found!","Splitter ",JOptionPane.OK_OPTION);
       else
       {
       ...
       JOptionPane.showMessageDialog((Container)null,"Unreadable error!","Splitter ",JOptionPane.OK_OPTION);
     }
   }
   else if(e.getSource()==b13)
   {
    try
    {
      if (tf4.getText().equals(""))
      {
        JOptionPane.showMessageDialog((Container)null,"No split file specified!","Splitter ",JOptionPane.OK_OPTION);
      }  
      else if(!(new File(tf4.getText()).exists()))
      {
        JOptionPane.showMessageDialog((Container)null,"Split file you specified not found or not correct!","Splitter ",JOptionPane.OK_OPTION);     
      ...
      else
      {
        ...
        if(!(beg.equals("jfs")))
        {
           JOptionPane.showMessageDialog((Container)null,"Not a valid split file!","Splitter ",JOptionPane.OK_OPTION);
        }
        else
        {
    ...
    {
      JOptionPane.showMessageDialog((Container)null,"Unexpected Error","Splitter ",JOptionPane.OK_OPTION);
      clearlab();
    }
   ...
   else if(e.getSource()==b18)
   {
    if(tf6.getText().equals(""))
      JOptionPane.showMessageDialog((Container)null,"Default split folder is not empty","Splitter ",JOptionPane.OK_OPTION);
    else if(tf7.getText().equals(""))
      JOptionPane.showMessageDialog((Container)null,"Default merge folder is not empty","Splitter ",JOptionPane.OK_OPTION);
    else
    {
     setConfig();
     getConfig();
     JOptionPane.showMessageDialog((Container)null,"Default values saved!","Splitter ",JOptionPane.INFORMATION_MESSAGE);
    }
   }
...
public void writeLog(String str)
{
	try
	   {
	    String cf = System.getProperty("user.dir") +
	             System.getProperty("file.separator") +
	             "Splitter.log"; 
	   FileWriter fwlog=new FileWriter(cf,true);
	   
	    BufferedWriter bwlog=new BufferedWriter(fwlog);
	   String data=getDateTime()+ " : " + str;
	   bwlog.append(data);
	   bwlog.newLine();
	   bwlog.close();
	   fwlog.close();
 ...
 public int split(String source,String dest,String dest1,String cmt,int no,int size,int lsize,boolean del,
                                  boolean wipe,boolean batch)
 {
    ...
    {
      JOptionPane.showMessageDialog((Container)null,"File not found","Splitter ",JOptionPane.OK_OPTION);
      writeLog(source + " Split failed");
      return 0;
    }
    try{
    if(wipe)
    {
      ...
      if((new File("A:/")).exists())
       ...
       {
         JOptionPane.showMessageDialog((Container)null,"No floppy drive found or Floppy Disk is not inserted!!","Splitter ",JOptionPane.OK_OPTION);              
         return 0;
       }
    }
    ...
    for(int i=1;i<=no;i++)
    {
      ...
      if((i % 2)==0)
      {
    	  fos=new FileOutputStream(new File(dest).getParent()+"/"+sname);
    	  
      }
      else
      {
    	  fos=new FileOutputStream(new File(dest1).getParent()+"/"+sname);
      }
    ...
    if(lsize!=0)
    {
      ...
      FileOutputStream fos1=new FileOutputStream(new File(dest).getParent()+"/"+sname);
  ...
  public int merge(String split,String dest,boolean del)
  {
    ...
    writeLog(split + " Merge success");
    JOptionPane.showMessageDialog((Container)null,"Merged successfully!","Splitter ",JOptionPane.INFORMATION_MESSAGE);
    return 1;
  }
 ...
 class filter1 extends javax.swing.filechooser.FileFilter 
 {
  ...
  class help extends javax.swing.JFrame
  {
    ...
    help()
    {
      ...
      {
        JOptionPane.showMessageDialog((Container)null,"Unable to locate the help file!!","Splitter ",JOptionPane.OK_OPTION);         
      }
    } 
  ...
  class about extends javax.swing.JFrame
   {
     ...
     about()
     {
       super("About Splitter ");
       la1=new JLabel("  Name       : ALL IN ONE Splitter(File Splitter)");
       la2=new JLabel("  Version    : 1.0.0(Pro)");
       la3=new JLabel("  Developed by : P K L");
       la4=new JLabel("                            ");
       la5=new JLabel("                             ");
       ...
       ta.setText("  This software is licensed as free software to \n"+ 
                   ...
                   "  please feel free to mail to:  PKLSOFTWARES@GMAIL.COM");
    ...
    public sizeset()
    {
     ...
     stf2.addFocusListener(new FocusAdapter()
     {
       public void focusLost(FocusEvent fe)
       {
        ...
        { JOptionPane.showMessageDialog((Container)null,stf2.getText()+" : This is not a valid size","Splitter ",JOptionPane.OK_OPTION);}
