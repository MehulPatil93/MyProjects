 ...
 * @author mehpa
 */
@Named(value = "sellerlogin")
@SessionScoped
public class sellerlogin implements Serializable {

   private String username;
   private String password;
   private item sellerdetail;

    public item getSellerdetail() {
        return sellerdetail;
    }

    public void setSellerdetail(item sellerdetail) {
   ...
   public String sellerlogin(){
       ...
       try{
           ...
           rs= stat.executeQuery("Select * from sellaccount "
                    + "where username = '" + 
                    username + "'" );
         // sellerid= rs.getInt(1);
           if(rs.next())
           {
               ...
               if(password.equals(rs.getString(3))){
                   ...
                   sellerdetail=new item(username,password);
